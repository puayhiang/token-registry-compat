...
// interface TitleEscrowCompatiblenterface extends ethers.utils.Interface {
//   functions: {
//     //V2 & V3
...
//   export type HolderChangedEvent = TypedEvent<
//     [string, string] & { previousHolder: string; newHolder: string }
//   >;
  
//   export type TitleCededEvent = TypedEvent<
...
//   export type TitleReceivedEvent = TypedEvent<
//     [string, string, BigNumber] & {
//       _tokenRegistry: string;
//       _from: string;
//       _id: BigNumber;
...
//   export type TransferOwnerApprovalEvent = TypedEvent<
...
//   export type TransferTitleEscrowApprovalEvent = TypedEvent<
//     [string, string] & { newBeneficiary: string; newHolder: string }
//   >;
  
//   export class V2TitleEscrowCloneable extends BaseContract {
...
//     interface: V2TitleEscrowCloneableInterface;
